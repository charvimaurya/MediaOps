...
Usage: python3 -m tools.trace <incident_id>
"""
...
def render_trace(incident: Incident) -> str:
    ...
    # New incidents use their durable event stream.  The fallback keeps this
    # debugging tool useful for older Firestore documents that predate it.
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("usage: python3 -m tools.trace <incident_id>")
    try:
