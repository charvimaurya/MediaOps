...
Standalone:
    python3 -m agents.infra_agent [encoder-overload | network-degradation | encoder-crash]
"""
...
def analyze_infra(
    ...
    *,
    ...
    for attempt in range(1, MAX_ATTEMPTS + 1):
        ...
        # Retain both the metric snapshot and Gemini's exact response so an
        # operator can reconstruct why this classification was made.
        ...
        # Emit the compact cross-component record used when grepping an incident.
